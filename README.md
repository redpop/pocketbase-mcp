...
[![Forked from mabeldata](https://img.shields.io/badge/Forked_from-mabeldata-green)](https://github.com/mabeldata/pocketbase-mcp)
[![Migration System Fixed](https://img.shields.io/badge/Migration_System-Fixed-brightgreen)](https://github.com/redpop/pocketbase-mcp)

**Fork Notice**: This is a fork of [mabeldata/pocketbase-mcp](https://github.com/mabeldata/pocketbase-mcp) with important fixes to the migration system.
...
## 🔧 Fixed Issues in this Fork

- ✅ **Migration Tool Registration**: Fixed missing migration tools in `tools/index.ts`
- ✅ **Migration Templates**: Updated to use PocketBase App API instead of SDK
